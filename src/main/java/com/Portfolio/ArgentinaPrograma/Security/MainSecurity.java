...
package com.Portfolio.ArgentinaPrograma.Security;

import com.Portfolio.ArgentinaPrograma.Security.Jwt.JwtEntryPoint;
import com.Portfolio.ArgentinaPrograma.Security.Jwt.JwtTokenFilter;
import com.Portfolio.ArgentinaPrograma.Security.Service.UserDetailsServiceImpl;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    http.cors().and().csrf().disable().authorizeRequests().mvcMatchers("auth/**").permitAll()
